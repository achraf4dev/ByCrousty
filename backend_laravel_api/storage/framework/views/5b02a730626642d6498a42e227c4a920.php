...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Panel de Admin'); ?> - <?php echo e(config('app.name')); ?></title>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.breadcrumb','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
</html><?php /**PATH /var/www/achraf.es/ByCrousty/backend_laravel_api/resources/views/layouts/admin/app.blade.php ENDPATH**/ ?>