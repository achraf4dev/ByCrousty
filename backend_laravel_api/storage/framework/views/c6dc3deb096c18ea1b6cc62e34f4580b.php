                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge <?php echo e($category->status === 'active' ? 'bg-success' : 'bg-secondary'); ?>">
                                        <?php echo e($category->status === 'active' ? 'Activa' : 'Inactiva'); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($product->price): ?>
                                                <span class="fw-semibold"><?php echo e($product->formatted_price); ?></span>
                                            <?php else: ?>
                                        ...
                                        <td>
                                            <span class="badge <?php echo e($product->status === 'active' ? 'bg-success' : 'bg-secondary'); ?>">
...
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/achraf.es/ByCrousty/backend_laravel_api/resources/views/admin/categories/show.blade.php ENDPATH**/ ?>