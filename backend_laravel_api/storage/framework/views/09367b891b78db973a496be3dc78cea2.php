        ...
        <div class="card">
            <div class="card-header bg-white">
                <h5 class="card-title mb-0">
                    ...
                    Editar Categoría: <?php echo e($category->name); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="slug" name="slug" value="<?php echo e(old('slug', $category->slug)); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                  ...
                                  placeholder="Describe esta categoría..."><?php echo e(old('description', $category->description)); ?></textarea>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="status" name="status" value="active" 
                                   <?php echo e(old('status', $category->status) === 'active' ? 'checked' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/achraf.es/ByCrousty/backend_laravel_api/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>