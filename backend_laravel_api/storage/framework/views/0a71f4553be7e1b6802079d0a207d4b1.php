...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($categoryOption->id); ?>" 
                                                <?php echo e(old('category_id', request('category')) == $categoryOption->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                  ...
                                  placeholder="Describe este producto..."><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="price" name="price" value="<?php echo e(old('price', 0)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="points" name="points" value="<?php echo e(old('points')); ?>" 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/achraf.es/ByCrousty/backend_laravel_api/resources/views/admin/products/create.blade.php ENDPATH**/ ?>