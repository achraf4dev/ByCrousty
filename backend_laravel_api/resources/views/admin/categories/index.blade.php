        ...
        <div class="card user-management-container">
            <div class="card-header bg-white d-flex justify-content-between align-items-center card-header-border">
                <h5 class="card-title mb-0 card-title-styled">
                    ...
                    Todas las Categorías ({{ $categories->total() }})
                </h5>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @foreach($categories as $category)
                                    <tr>
                                        <td class="table-text-muted-weight">{{ $category->id }}</td>
                                        <td>
                                            <div>
                                                <div class="user-name-primary">{{ $category->name }}</div>
                                                @if($category->description)
                                                    <div class="user-id-secondary">{{ Str::limit($category->description, 50) }}</div>
                                                @endif
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="table-text-muted">{{ $category->created_at->format('M d, Y') }}</td>
                                        <td>
