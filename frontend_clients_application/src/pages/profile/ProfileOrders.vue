...
<template>
  <div class="profile-subpage-page">
    ...
    <div class="profile-orders">
      <p>Lista de pedidos realizada por el usuario. Puedes integrar aquí la llamada a la API '/orders' cuando la tengas.</p>
    </div>
  </div>
</template>
...
.profile-orders p { margin:0.5rem 0; }
</style>